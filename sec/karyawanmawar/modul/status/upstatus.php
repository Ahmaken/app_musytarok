...
$kode = $_GET['id'];
$q = mysql_query("SELECT a.nik, b.nama, a.status as kodestatus, a.landasan, date_format(a.tanggal, '%d-%m-%Y') as tanggal, c.status FROM karyawan_mutasistatus a, karyawan_master b, karyawan_status c WHERE a.status=c.id AND a.nik=b.nik and a.id='$kode'");
                        ...
                        <div class="col-lg-5">
                            <section class="panel">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form">
                                        <form id="kabupatenupdate" class="cmxform form-horizontal tasi-form" method="post" action="prospenempatan.php?type=update">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-5">
                                                    <select id="landasan" name="status" class="form-control" required="" type="text">
                                                        ...
                                                        while ($row = mysql_fetch_array($qs)) {
                                                            $kodestatus = $row['id'];
                                                            $status = $row['status'];
                                                            if ($tampil['kodestatus'] == $kodestatus) {
                                                                echo "<option selected value='$kodestatus'> $status</option>";
                                                            } else {
                                                                echo "<option value='$kodestatus'> $status</option>";
                                                            }
                                                        }
                                                        ?>
                                                    </select>
                                                ...
                                                <div class="col-sm-4">
                                                    <input type="text" class="form-control" required placeholder="hh-bb-tttt" data-mask="99-99-9999" name="tglawal" value="<?php echo $tampil['tanggal'] ?>">
                                                </div>
                                            </div> 
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-5">
                                                    <select id="landasan" name="landasan" class="form-control" required="" type="text">
                                                        ...
                                                        while ($row = mysql_fetch_array($qs)) {
                                                            ...
                                                            if ($tampil['landasan'] == $row['id']) {
                                                                echo "<option selected value='$kode'> $landasan</option>";
                                                            } else {

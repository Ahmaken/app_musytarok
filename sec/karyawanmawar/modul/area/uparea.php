...
$kode = $_GET['id'];
$q = mysql_query("SELECT * from umum_area where id='$kode'");
                        ...
                        <div class="col-lg-5">
                            <section class="panel">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form">
                                        <form id="inputinv" class="cmxform form-horizontal tasi-form" method="post" action="prosarea.php?type=update">
                                             <div class="form-group">
                                                <label class="col-sm-4 control-label">Kode Area</label>
                                                <div class="col-sm-5">
                                                    <input id="kode" name="kode" autofocus="" placeholder="Kode Area" class="form-control" required="" type="text" value="<?php echo $tampil['kode'] ?>" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-5">
                                                    <input id="kode" name="nama"  placeholder="Nama Area" class="form-control" required="" type="text" value="<?php echo $tampil['namaarea'] ?>" />
                                                </div>
                                            </div>   
                                            <div class="form-group">

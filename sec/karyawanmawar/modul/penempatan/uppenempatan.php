...
$kode = $_GET['id'];
$q = mysql_query("SELECT a.id, a.nik, d.nama, a.cabang, b.nama as namacabang, DATE_FORMAT(a.tglawal, '%d-%m-%Y') AS tglawal, DATE_FORMAT(a.tglakhir, '%d-%m-%Y') AS tglakhir, a.landasan as idlandasan, c.landasan, a.keterangan FROM karyawan_penempatan a, umum_cabang b, karyawan_landasanmutasi c, karyawan_master d WHERE a.cabang=b.kode AND a.landasan=c.id AND a.nik=d.nik AND a.id='$kode'");
                                    ...
                                    <div class="form">
                                        <form id="kabupatenupdate" class="cmxform form-horizontal tasi-form" method="post" action="prospenempatan.php?type=update">
                                                ...
                                                <div class="col-sm-4">
                                                    ...
                                                    <input id="kode" name="id" autofocus=""  type="hidden" value="<?php echo $tampil['id']?>" />
                                                </div>
                                                <div class="col-sm-5">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-4">
                                                    <input id="kodecabang" name="kodecabang" placeholder="Kode Cabang" class="form-control" required="" value="<?php echo $tampil['cabang']?>" type="text"/>
                                                </div>
                                                <div class="col-sm-5">
                                                    <input id="cabang" name="cabang" readonly placeholder="Cabang" class="form-control"   type="text" value="<?php echo $tampil['namacabang']?>" />
                                                </div>
                                            </div>    
                                            <div class="form-group">

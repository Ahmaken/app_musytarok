...
<html lang="en">
            ...
            <section id="main-content">
                <section class="wrapper">
                    ...
                    <div class="row state-overview">
                        ...
                        <div class="col-lg-6">
                            <section class="panel">
                                <header class="panel-heading"><b>Penetapan Jabatan</b></header>
                                <div class="panel-body">
                                    ...
                                    <div class="form">
                                        <form id="frmpenempatan" class="cmxform form-horizontal tasi-form" method="post" action="prosposisi.php?type=save">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-4">
                                                    <input id="kodejabatan" name="kodejabatan" placeholder="Kode Jabatan" class="form-control" required="" type="text"/>
                                                </div>
                                                <div class="col-sm-5">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-4">
                                                   <input type="text" class="form-control" placeholder="hh-bb-tttt" data-mask="99-99-9999" name="tglawal">
                                                </div>
                                                <div class="col-sm-4">
                                                   <input type="text" class="form-control" placeholder="hh-bb-tttt" data-mask="99-99-9999" name="tglakhir">
                                                </div>
                                            </div>  
                                            <div class="form-group">
                                    ...
                                    <div class="adv-table">
                                        <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered table-striped" id="hidden-table-info">
                                            ...
                                            <tbody>
                                                <?php
                                                $i = 1;
                                                $q = mysql_query("SELECT a.id, a.nik, b.nama, c.jabatan as jabatan FROM karyawan_mutasijabatan a, karyawan_master b, karyawan_jabatan c WHERE a.nik=b.nik AND a.jabatan=c.kode AND a.status='1' order by a.id desc;");
                                                while ($hasil = mysql_fetch_array($q)) {
                                                    ...
                                                    . "<td>" . $hasil['nama'] . "</td>"
                                                    . "<td>" . $hasil['jabatan'] . "</td>"
                                                    . "<td><a rel='tooltip-top' title='Edit' href='upposisi.php?id=" . $hasil['id'] . "'>"
    ...
    <script>
        function delet(id) {
            ...
            if (tanya == 1) {
                window.location.href = "prosposisi.php?type=delete&kode=" + id;
            }
        }

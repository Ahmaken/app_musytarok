            ...
            <section id="main-content">
                <section class="wrapper">
                                ...
                                <div class="panel-body">
                                    ...
                                    <form name="fr" id="fr" class="form-inline" role="form" method="post" action="saveins.php?jenis=save">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="instansi" name="gedung" placeholder="Gedung">
                                        </div>
                    ...
                    <div class="row state-overview">
                        ...
                        <div class="col-lg-8">
                            <section class="panel">
                                <header class="panel-heading">GEDUNG</header>
                                <div class="panel-body">
                                    <table class="table table-striped table-advance table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            $no = 1;
                                            $q = mysql_query("select kode, UPPER(gedung) as gedung from umum_gedung");
                                            while ($show = mysql_fetch_array($q)) {
                                                echo "<tr><td>" . $no++ . "</td><td>" . $show['kode'] . "</td><td>" . $show['gedung'] . "</td>"
                                                . "<td><a class='btn btn-primary btn-xs' href='updateins.php?id=" . $show['kode'] . "'>"
                                                . "<i class='icon-pencil'></i></a> <a class='btn btn-default btn-xs' "
                                                . "data-toggle='modal' onclick='idConfirm(" . $show['kode'] . ");' href='#modconfirm'><i class='icon-remove'></i></a></td></tr>";
                                            }
                                            ?>
                                        </tbody>
                                        <!-- Modal -->

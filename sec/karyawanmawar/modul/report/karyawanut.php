                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered table-striped" id="hidden-table-info">
                                            ...
                                            <tbody>
                                                ...
                                                $q = mysql_query("SELECT a.id, a.nik, a.nama, CONCAT(a.tempatlahir,', ', DATE_FORMAT(a.tgllahir, '%d-%m-%Y')) AS ttl, "
                                                        . "YEAR(CURDATE()) - YEAR(a.tgllahir) AS age, b.cabang, d.jabatan, CONCAT(a.hp1,', ', a.hp2) AS telp "
                                                        . " FROM karyawan_master a JOIN max_penempatan b ON a.nik=b.nik JOIN umum_cabang c ON b.cabang=c.kode LEFT JOIN max_mutasijabatan d ON a.nik=d.nik WHERE DATE_FORMAT (a.tgllahir,'%m-%d') = date_format(now(),'%m-%d') AND a.status=1 ORDER BY nik ASC;");

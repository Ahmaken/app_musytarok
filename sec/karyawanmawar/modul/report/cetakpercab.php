                            ...
                            <div class="adv-table">
                                <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                                    ...
                                    <tbody>
                                        ...
                                        $no = 1;
                                        $q = mysql_query("SELECT a.nik, a.noktp, UPPER(a.nama) AS nama, CONCAT(a.tempatlahir, ', ', DATE_FORMAT(a.tgllahir, '%d/%m/%Y')) AS ttl, CONCAT(a.alamat, ' ', a.desa, ' ', a.kecamatan, ' ', a.kota) AS alamat, CONCAT(a.hp1, ', ', a.hp2) AS hp,a.email,  a.ibukandung, b.cabang, d.jabatan FROM karyawan_master a JOIN max_penempatan b ON a.nik=b.nik JOIN umum_cabang c ON b.cabang=c.kode LEFT JOIN max_mutasijabatan d ON a.nik=d.nik WHERE a.status=1" . $wherecab . "" . $wherekoor . " ORDER BY a.id ASC");
                                        ...
                                        while ($row = mysql_fetch_array($q)) {
                                            ...
                                            . "" . $row['alamat'] . "</td><td>" . $row['hp'] . "</td><td>" . $row['email'] . "</td><td>" . $row['cabang'] . "</td><td>" . $row['jabatan'] . "</td></tr>";
                                        }
                                        ?>
                                    </tbody>
                                </table>

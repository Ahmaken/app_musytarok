                                ...
                                <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="hidden-phone">Status Nikah</th>
                                            <th class="hidden-phone">Jum. Anak</th>
                                            <th class="hidden-phone">Jarak Kantor</th>
                                            <th class="hidden-phone">Lama Tugas</th>
                                    ...
                                    <tbody>
                                        ...
                                        $no = 1;
                                        $q = mysql_query("SELECT a.nik, UPPER(a.nama) AS nama, YEAR(CURDATE()) - YEAR(a.tgllahir) AS age, a.statusnikah, a.jumlahanak, a.jarakkantor, YEAR(CURDATE()) - a.tahunmasuk AS lam, b.cabang, d.jabatan FROM karyawan_master a JOIN max_penempatan b ON a.nik=b.nik JOIN umum_cabang c ON b.cabang=c.kode LEFT JOIN max_mutasijabatan d ON a.nik=d.nik WHERE a.status=1" . $wherecab . "" . $wherekoor . " ORDER BY a.id ASC");
                                        ...
                                        while ($row = mysql_fetch_array($q)) {
                                            echo "<tr><td align=center>" . $no++ . "</td><td>" . $row['nik'] . "</td><td>" . $row['nama'] . "</td><td align=center>" . $row['age'] . "</td><td>"
                                            . "" . $row['statusnikah'] . "</td><td align=center>" . $row['jumlahanak'] . "</td><td align=center>" . $row['jarakkantor'] . "</td><td align=center>" . $row['lam'] . "</td><td>" . $row['cabang'] . "</td><td>" . $row['jabatan'] . "</td></tr>";
                                        }
                                        ?>
                                    </tbody>
                                </table>

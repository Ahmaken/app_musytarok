            ...
            <section id="main-content">
                <section class="wrapper">
                    ...
                    <div class="row state-overview">
                        ...
                        <div class="col-lg-8">
                            <section class="panel">
                                <header class="panel-heading">Cetak Label Inventaris</header>   
                                <header class="panel-heading tab-bg-dark-navy-blue ">
                                    <ul class="nav nav-tabs">
                                        <li class="active">
                                            <a data-toggle="tab" href="#pertanggal">Pertanggal</a>
                                        </li>
                                        <li class="">
                                            <a data-toggle="tab" href="#perkode">Perkode</a>
                                        </li>
                                        <li class="">
                                            <a data-toggle="tab" href="#pergolongan">Pergolongan</a>
                                        </li>
                                        <li class="">
                                            <a data-toggle="tab" href="#perinstansi">Perinstansi</a>
                                        </li>
                                    </ul>
                                </header>
                                    ...
                                    <div class="tab-content">
                                        <div id="pertanggal" class="tab-pane active">
                                            <div class="form-group">
                                                <div class="panel-body">
                                                    <div class="form">
                                                        <form id="frmrekap" class="cmxform form-horizontal tasi-form" method="POST" action="../../fpdf/printlabel.php?type=pertanggal" target="_blank">
                                                            <label class='col-sm-2 control-label' id='labeltgl'>Tanggal</label>
                                                            <div class='col-md-3 col-xs-11'>
                                                                <input placeholder='Tanggal' class='form-control form-control-inline input-medium default-date-picker'  required name='tanggal' id='tanggal' size='16' type='text' value='' /></div>
                                                            <div class='col-md-3 col-xs-11'>
                                                                <input placeholder='Tanggal Akhir' class='form-control form-control-inline input-medium default-date-picker'  name='tanggal2' id='tanggal2' size='16' type='text' value=''></div>

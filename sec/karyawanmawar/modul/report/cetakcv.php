...
<html lang="en">
    <head>
        ...
        <title>Cetak | Pondok Pesantren Matholi'ul Anwar</title>
            ...
            <section id="main-content">
                <section class="wrapper">
                    ...
                    <div class="row state-overview">
                        ...
                        <div class="col-lg-8">
                            <section class="panel">
                                <header class="panel-heading">Cetak PDF</header>   
                                <header class="panel-heading tab-bg-dark-navy-blue ">
                                    <ul class="nav nav-tabs">
                                        <li class="active">
                                            <a data-toggle="tab" href="#pertanggal">NIP</a>
                                        </li>
                                        <li class="">
                                            <a data-toggle="tab" href="#perkode">Cabang</a>
                                        </li>
                                        <li class="">
                                    ...
                                    <div class="tab-content">
                                        <div id="pertanggal" class="tab-pane active">
                                            <div class="form-group">
                                                <div class="panel-body">
                                                    <div class="form">
                                                        <form id="frmrekap" class="cmxform form-horizontal tasi-form" method="POST" action="../reportpdf/cvpdf.php?type=bynik" target="_blank">
                                                            <label class="col-sm-1 control-label">NIK</label>
                                                            <div class="col-sm-4">
                                                                <input id="kode" name="nik" autofocus="" placeholder="NIK" class="form-control" required="" type="text" value="" />
                                                            </div>
                                                            <div class="col-sm-5">

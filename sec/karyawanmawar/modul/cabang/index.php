...
<html lang="en">
            ...
            <section id="main-content">
                <section class="wrapper">
                    ...
                    <!--            <div class="panel-body">
                                    ...
                                    <div class="form">
                                        <form id="inputinv" class="cmxform form-horizontal tasi-form" method="post" action="proscab.php?type=save">
                                            <div class="form-group">
                                                <label class="col-sm-4 control-label">Kode</label>
                                                <div class="col-sm-5">
                                                    <input id="kode" name="kode" autofocus="" placeholder="Kode" class="form-control" required="" type="text" value="" />
                                                </div>
                                            </div>    
                                            <div class="form-group">
                                                <label class="col-sm-4 control-label">Nama Cabang</label>
                                                <div class="col-sm-8">
                                                    <input id="kode" name="nama"  placeholder="Nama Cabang" class="form-control" required="" type="text" value="" />
                                                </div>
                                            </div>   
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-5">
                                                    <select name="kodekab" class="form-control" required>
                                                        ...
                                                        while ($row = mysql_fetch_array($q)) {
                                                            $kode= $row['kode'];
                                                            $namaarea= $row['namakabupaten'];
                                                            echo "<option value='$kode'> $namaarea</option>";
                                                        }
                                                        ?>
                                                    </select>
                                                </div>
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <textarea id="kode" name="alamat"  placeholder="Alamat" class="form-control" required="" type="text"></textarea>
                                                </div>
                                            </div>
                                             <div class="form-group">
                                                <label class="col-sm-4 control-label">Telepon</label>
                                                <div class="col-sm-8">
                                                    <input id="kode" name="telepon"  placeholder="Telepon" class="form-control" required="" type="text" value="" />
                                                </div>
                                            </div>
                                             <div class="form-group">
                                                <label class="col-sm-4 control-label">Email</label>
                                                <div class="col-sm-8">
                                                    <input id="kode" name="email"  placeholder="Email" class="form-control" required="" type="email" value="" />
                                                </div>
                                            </div>
                                             <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <select id="kode" name="usaha"  placeholder="Usaha" class="form-control" required>
                                                        <option selected value="">Usaha:</option>
                                                            <?php
                                                            $q= mysql_query("SELECT * from umum_usaha");
                                                        while ($row = mysql_fetch_array($q)) {
                                                            $kode= $row['id'];
                                                            $usaha= $row['usaha'];
                                              ...
                                              <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                   <input type="text" class="form-control" placeholder="hh-bb-tttt" data-mask="99-99-9999" name="berdiri" id="tanggallahir">
                                                </div>
                                            </div>
											<div class="form-group">
                                                <label class="col-sm-4 control-label">Nomor NPP</label>
                                                <div class="col-sm-8">
                                                    <input id="kode" name="npp"  placeholder="npp" class="form-control" required="" type="text" value="" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered table-striped" id="hidden-table-info">
                                            ...
                                            <tbody>
                                                ...
                                                while ($hasil = mysql_fetch_array($q)) {
                                                    ...
                                                    . "<td>" . $hasil['email'] . "</td>"
                                                    . "<td>" . $hasil['telepon'] . "</td>"
                                                    . "<td>" . $hasil['tglberdiri'] . "</td>"
                                                    . "<td>" . $hasil['npp'] . "</td>"
                                                    . "<td><a rel='tooltip-top' title='Edit' href='upcab.php?id=" . $hasil['id'] . "'>"
    ...
    <script>
        function delet(nip) {
            ...
            if (tanya == 1) {
                window.location.href = "proscab.php?type=delete&kode=" + nip;
            }
        }

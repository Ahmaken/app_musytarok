                        ...
                        <div class="col-lg-8">
                            <section class="panel">
                                ...
                                <div class="panel-body">
                                    ...
                                    $q = mysql_query("select * from inv_golongan where id='$id'");
                                    while ($hasil = mysql_fetch_array($q)) {
                                        $kode = $hasil['id'];
                                        $instansi = $hasil['golongan'];
                                    }
                                    ?>
                                    <form name="fr" id="fr" class="form-inline" role="form" method="post" action="saveins.php?jenis=update">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo "$instansi"; ?>" id="instansi" name="golongan">
                                        </div>

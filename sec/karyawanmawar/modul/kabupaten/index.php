...
<html lang="en">
            ...
            <section id="main-content">
                <section class="wrapper">
                    ...
                    <div class="row state-overview">
                        ...
                        <div class="col-lg-5">
                            <section class="panel">
                                <header class="panel-heading"><b>Kabupaten</b></header>
                                <div class="panel-body">
                                    ...
                                    <div class="form">
                                        <form id="inputinv" class="cmxform form-horizontal tasi-form" method="post" action="proskab.php?type=save">
                                            <div class="form-group">
                                                <label class="col-sm-4 control-label">Kode Kab</label>
                                                <div class="col-sm-5">
                                                    <input id="kode" name="kode" autofocus="" placeholder="Kode Kab" class="form-control" required="" type="text" value="" />
                                                </div>
                                            </div>    
                                            <div class="form-group">
                                                <label class="col-sm-4 control-label">Nama Kab</label>
                                                <div class="col-sm-8">
                                                    <input id="kode" name="nama"  placeholder="Nama Kab" class="form-control" required="" type="text" value="" />
                                                </div>
                                            </div>   
                                            <div class="form-group">
                                    ...
                                    <div class="adv-table">
                                        <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered table-striped" id="hidden-table-info">
                                            ...
                                            <tbody>
                                                <?php
                                                $i = 1;
                                                $q = mysql_query("SELECT * FROM umum_kabupaten ORDER BY id desc;");
                                                while ($hasil = mysql_fetch_array($q)) {
                                                    echo "<tr class='gradeX'>"
                                                    . "<td>" . $i++ . "</td>"
                                                    . "<td>" . $hasil['kode'] . "</td>"
                                                    . "<td>" . $hasil['namakabupaten'] . "</td>"
                                                    . "<td>" . $hasil['kodearea'] . "</td>"
                                                    . "<td>" . $hasil['keterangan'] . "</td>"
                                                    . "<td><a rel='tooltip-top' title='Edit' href='upkab.php?id=" . $hasil['id'] . "'>"
    ...
    <script>
        function delet(nip) {
            ...
            if (tanya == 1) {
                window.location.href = "proskab.php?type=delete&kode=" + nip;
            }
        }

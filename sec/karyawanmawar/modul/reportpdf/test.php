...
$query ="select induk,nama, alamat,tanggallahir from master_santri order by nama";
...
$cell[$i][1] = $data[1];
$cell[$i][2] = $data[2];
$cell[$i][3] = date('d-m-Y',  strtotime($data[3]));
$i++;
}
...
$this->Cell(0,1,'Data Pribadi','',0,'C',1); //TBLR (untuk garis)=> B = Bottom,
// L = Left, R = Right

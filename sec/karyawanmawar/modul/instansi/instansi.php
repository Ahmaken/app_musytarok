            ...
            <section id="main-content">
                <section class="wrapper">
                                ...
                                <div class="panel-body">
                                    ...
                                    <form name="fr" id="fr" class="form-inline" role="form" method="post" action="saveins.php?jenis=save">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="instansi" name="instansi" placeholder="Ruang">
                                        </div>
                                        <div class="form-group">
                                            <label class="sr-only" for="">Ruang</label>
                                            <select class="form-control" required id="golongan" name="gedung" placeholder="Gedung" required>
                                                <option selected value="">Gedung</option>
                                                <?php
                                                include '../../config/kon.php';
                                                $gol = mysql_query("select * from umum_gedung");
                                                while ($hasil = mysql_fetch_array($gol)) {
                                                    echo "<option value=" . $hasil['kode'] . ">" . $hasil['gedung'] . "</option>";
                                                }
                                                ?>
                    ...
                    <div class="row state-overview">
                        ...
                        <div class="col-lg-8">
                            <section class="panel">
                                <header class="panel-heading">RUANG</header>
                                <div class="panel-body">
                                    <table class="table table-striped table-advance table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><i class="icon-tasks"></i> RUANG </th>
                                                <th><i class="icon-tasks"></i> GEDUNG </th>
                                        ...
                                        <tbody>
                                            ...
                                            include '../../config/kon.php';
                                            $no = 1;
                                            $q = mysql_query("select a.id, UPPER(a.instansi) as instansi, b.gedung from umum_instansi a, umum_gedung b where a.gedung=b.kode");
                                            while ($show = mysql_fetch_array($q)) {
                                                echo "<tr><td>" . $no++ . "</td><td>" . $show['id'] . "</td><td>" . $show['instansi'] . "</td><td>" . $show['gedung'] . "</td>"

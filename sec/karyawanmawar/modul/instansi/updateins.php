                        ...
                        <div class="col-lg-8">
                            <section class="panel">
                                ...
                                <div class="panel-body">
                                    ...
                                    $q = mysql_query("select * from umum_instansi where id='$id'");
                                    ...
                                    <form name="fr" id="fr" class="form-inline" role="form" method="post" action="saveins.php?jenis=update">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo "$instansi"; ?>" id="instansi" name="instansi">
                                        </div>
                                    ...
                                    <table class="table table-striped table-advance table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><i class="icon-tasks"></i> INSTANSI </th>
                                        ...
                                        <tbody>
                                            ...
                                            include '../../config/kon.php';
                                            $no = 1;
                                            $q = mysql_query("select id, UPPER(instansi) as instansi from umum_instansi");
                                            while ($show = mysql_fetch_array($q)) {
                                                echo "<tr><td>" . $no++ . "</td><td>" . $show['id'] . "</td><td>" . $show['instansi'] . "</td>"
                                                . "<td><a class='btn btn-primary btn-xs' href=updateins.php?id=" . $show['id'] . "><i class='icon-pencil'></i></a></td></tr>";
                                            }
                                            ?>
                                        </tbody>

...
<html lang="en">
            ...
            <section id="main-content">
                <section class="wrapper">
                    ...
                    <div class="row state-overview">
                        ...
                        <div class="col-lg-6">
                            <section class="panel">
                                <header class="panel-heading"><b>Leveling</b></header>
                                <div class="panel-body">
                                    ...
                                    <div class="form">
                                        <form id="formleveling" class="cmxform form-horizontal tasi-form" method="post" action="prosleveling.php?type=save">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-5">
                                                    <select id="landasan" name="level" class="form-control" required="" type="text">
                                                     <option value="">Level:</option>
                                                        <?php
                                                        include '../../config/kon.php';
                                                        $qs = mysql_query("SELECT id, level from karyawan_level");
                                    ...
                                    <div class="adv-table">
                                        <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered table-striped" id="hidden-table-info">
                                            ...
                                            <tbody>
                                                <?php
                                                $i = 1;
                                                $q = mysql_query("SELECT a.id, a.nik, b.nama, a.level AS leveling FROM karyawan_leveling a, karyawan_master b WHERE a.nik=b.nik  AND a.status='1' ORDER BY a.id DESC;");
                                                while ($hasil = mysql_fetch_array($q)) {
                                                    echo "<tr class='gradeX'>"
                                                    . "<td>" . $i++ . "</td>"
                                                    . "<td>" . $hasil['nik'] . "</td>"
                                                    . "<td>" . $hasil['nama'] . "</td>"
                                                    . "<td>" . $hasil['leveling'] . "</td>"
                                                    . "<td><a rel='tooltip-top' title='Edit' href='uppelevelan.php?id=" . $hasil['id'] . "'>"
    ...
    <script>
        function delet(id) {
            ...
            if (tanya == 1) {
                window.location.href = "prosleveling.php?type=delete&kode=" + id;
            }
        }
        ...
        $('#menupelevelan').attr('class', 'active');

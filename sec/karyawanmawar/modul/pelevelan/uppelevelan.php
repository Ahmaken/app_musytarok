...
$kode = $_GET['id'];
$q = mysql_query("SELECT a.id, a.nik, b.nama, a.level AS leveling, a.landasan AS idlandasan, c.landasan, a.keterangan  FROM karyawan_leveling a, karyawan_master b, karyawan_landasanmutasi c WHERE a.nik=b.nik  AND a.landasan=c.id AND a.status='1' AND a.id='$kode';");
            ...
            <section id="main-content">
                <section class="wrapper">
                    ...
                    <div class="row state-overview">
                        ...
                        <div class="col-lg-5">
                            <section class="panel">
                                <header class="panel-heading"><b>Edit Leveling</b></header>
                                <div class="panel-body">
                                    ...
                                    <div class="form">
                                        <form id="kabupatenupdate" class="cmxform form-horizontal tasi-form" method="post" action="prosleveling.php?type=update">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-5">
                                                    <select id="landasan" name="level" class="form-control" required="" type="text">
                                                     ...
                                                     <option selected value="<?php echo $tampil['leveling'] ?>"><?php echo $tampil['leveling'] ?></option>
                                                        <?php
                                                        include '../../config/kon.php';

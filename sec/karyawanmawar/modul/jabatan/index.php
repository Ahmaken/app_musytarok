...
<html lang="en">
                        ...
                        <div class="col-lg-5">
                            <section class="panel">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form">
                                        <form id="inputinv" class="cmxform form-horizontal tasi-form" method="post" action="prosjab.php?type=save">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input id="jabatan" name="jabatan"  placeholder="Jabatan" class="form-control" required="" type="text" value="" />
                                                </div>
                                            </div>   
                                            <div class="form-group">
                                    ...
                                    <div class="adv-table">
                                        <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered table-striped" id="hidden-table-info">
                                            ...
                                            <tbody>
                                                <?php
                                                $i = 1;
                                                $q = mysql_query("SELECT a.id, a.kode, a.jabatan, c.departemen, b.koordinator FROM karyawan_jabatan a, karyawan_koordinator b, karyawan_departemen c where a.departemen=c.id and a.koordinator=b.id;");
                                                while ($hasil = mysql_fetch_array($q)) {
                                                    ...
                                                    . "<td>" . $hasil['koordinator'] . "</td>"
                                                    . "<td><a rel='tooltip-top' title='Edit' href='upjab.php?id=" . $hasil['id'] . "'>"
    ...
    <script>
        function delet(nip) {
            ...
            if (tanya == 1) {
                window.location.href = "prosjab.php?type=delete&kode=" + nip;
            }
        }

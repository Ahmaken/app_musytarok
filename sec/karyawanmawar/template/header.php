...
<header class="header white-bg">
    ...
    <!--logo start-->
    <a href="index.html" class="logo">SIDOGIRI<span> MITRA UTAMA</span></a>
    <!--logo end-->
    ...
    <div class="top-nav ">
        ...
        <ul class="nav pull-right top-menu">
            ...
            <!-- user login dropdown start-->
             <li class="dropdown">
                <br>
                <div style="font-size: 15px;"><?php $blnindo= date('m'); $hariindo= date('w'); include '../../config/tanggal.php'; echo $hariindo.", ".date('d')." ".$blnindo." ".date('Y')." --";?></div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="edituser" class="cmxform form-horizontal tasi-form" method="post" action="../user/saveuser.php?jenis=edit">
                    ...
                    $q = mysql_query("SELECT nik FROM umum_user where nik=" . $username);

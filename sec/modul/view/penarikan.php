...
<html lang="id">
    ...
    <body>
                            ...
                            <section class="panel">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form" id="addpenerimaan">
                                        <form id="jurnalpenerimaan" class="cmxform form-horizontal tasi-form" method="post" action="prossimpanan.php?type=penarikan">
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" required="" readonly="" class="form-control" name="saldo"  placeholder="Saldo" id="saldo">
                                                </div>
                                            </div>    
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">Nominal</label>
                                                <div class="col-sm-5">
                                                    <input type ="text" required="" class="form-control" name="nominal" onkeyup="javascript: tandaPemisahTitik(this)" onkeydown="return numbersonly(this, event)" id="nominal" placeholder="Nominal"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered table-striped" id="hidden-table-info">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="numeric">Print</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
                                                //include '../../config/security.php';
                                                $q = mysql_query("SELECT DATE_FORMAT(a.tanggal, '%d/%m/%Y') AS tanggal, a.kode, a.kode_anggota, b.nama, a.kredit FROM anggota_simpanan a, anggota_master b WHERE a.kode_anggota=b.kode and a.debet=0 ORDER BY a.id desc LIMIT 20;");
                                                $no = 1;
                                                $kodex = md5('kode');
                                                while ($r = mysql_fetch_array($q)) {
                                                    $kodetrans = urlencode(encryptIt($r['kode']));
                                                    echo "<tr><td>" . $no++ . "</td><td>" . $r['tanggal'] . "</td><td>" . $r['kode'] . "</td><td>" . $r['kode_anggota'] . "</td><td>" . $r['nama'] . "</td>"
                                                    . "<td class='numeric' id='harga'>" . number_format($r['kredit'], 0, '.', '.') . "</td>"
                                                    . "<td><a rel='tooltip-top' target='_blank' title='Cetak' href='../reportpdf/slipsetoran.php?$kodex=$kodetrans'>"
                                                    . "<i class='icon-print'></i></a></td></tr>";
                                                }
                                                ?>
                                            </tbody>
                                        </table>
        ...
        <script type="text/javascript">
                                                        ...
                                                        $(document).ready(function() {
                                                            $("#kodeanggota").autocomplete("../../config/getsaldo.php?type=kode", {
                                                                width: 250
                                                            });
                                                            ...
                                                            $("#kodeanggota").result(function(event, data, formatted) {
                                                                ...
                                                                $.ajax({
                                                                    type: "POST",
                                                                    data: "kode=" + kode,
                                                                    url: "../../config/getsaldo.php?type=data",
                                                                    dataType: "json",
                                                        ...
                                                        $('#submenupenarikan').attr('class', 'active');

                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered table-striped" id="hidden-table-info">
                                            ...
                                            <tbody>
                                                ...
                                                $q = mysql_query("SELECT a.id, a.kode, a.nama,  CONCAT(a.tempatlahir, ', ', DATE_FORMAT(a.tanggallahir, '%d/%m/%Y')) AS ttl, 
                                                        ...
                                                        DATE_FORMAT(a.tanggaldaftar, '%d/%m/%Y') AS tanggaldaftar, a.operator FROM anggota_master a, anggota_status b, kabupaten c, kecamatan d WHERE a.status=1 AND a.kecamatan=d.kecamatanId AND a.kabupaten=c.kabupatenId
                                                        AND a.status_anggota=b.id  ORDER BY a.tanggaldaftar;");

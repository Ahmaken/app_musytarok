...
if (isset($iddescryp)) {
    ...
    $q = mysql_query("SELECT * from anggota_master where id='$idbaris' and status=1");
    $qalamat = mysql_query("SELECT a.provinsi, b.provinsiNama, a.kabupaten, c.kabupatenNama, a.kecamatan, d.kecamatanNama FROM anggota_master a, provinsi b, kabupaten c, kecamatan d WHERE a.provinsi=b.provinsiId AND a.kabupaten=c.kabupatenId AND a.kecamatan=d.kecamatanId AND a.id='$idbaris'");
            ...
            <section id="main-content">
                <section class="wrapper">
                    ...
                    <div class="row state-overview">
                        ...
                        <div class="col-lg-12">
                            <section class="panel">
                                <header class="panel-heading"><b>Edit Aggota</b></header>
                                    ...
                                    <div class="form">
                                        <form id="formanggota" class="cmxform form-horizontal tasi-form" method="post" action="prosanggota.php?type=update">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input id="ktp" name="kode"  placeholder="Kode Anggota" class="form-control" required="" type="text" value="<?php echo $hasil['kode'] ?>"/>

    ...
    <body class="login-body">
        <div class="container">
            <form class="form-signin" id='frmlogin' method="post" action="ceklogin.php">
                <h2 class="form-signin-heading">Pondok Pesantern Matholi'ul Anwar</h2>
                <div class="login-wrap">
                    ...
                    <button class="btn btn-l btn-login btn-block" type="submit">Login</button>
<a href='../../../index.php'class="btn btn-large btn-block">Menu Utama</a>
       ...
       <div class="site-footer">
            <div class="text-center">
                Enterprise Management Sistem  2015 &copy; Pondok Pesantern Matholi'ul Anwar

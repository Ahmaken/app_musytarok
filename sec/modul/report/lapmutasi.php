                            ...
                            <section id="unseen">
                                <table class="table table-bordered table-striped table-condensed">
                                    ...
                                    <tbody>
                                        ...
                                        $operator = $_SESSION['username'];
                                        $no = 1;
                                        $q = mysql_query("SELECT CONCAT(DATE_FORMAT(a.tanggal, '%d-%m-%Y'),' ' ,a.jam) AS tanggal, a.jenis, a.kode, a.kode_anggota, b.nama, a.debet, a.kredit, a.operator  FROM anggota_simpanan a, anggota_master b WHERE a.kode_anggota=b.kode " . $iftanggal . " ORDER BY a.tanggal, a.jam ASC");
                                        while ($row = mysql_fetch_array($q)) {
                                            ...
                                            . "<td id='harga'>" . number_format($row['kredit'], 0, '.', '.') . "</td>"
                                             . "<td>" . $row['operator'] . "</td></tr>";
                                        }
                                        ?>
                                        <tr>
...
//                                              
                    ...
                    $('#submenumutasi').attr('class', 'active');

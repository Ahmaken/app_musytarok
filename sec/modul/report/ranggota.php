                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered table-striped" id="hidden-table-info">
                                            ...
                                            <tbody>
                                                ...
                                                if($_GET['provinsi']!=""&&$_GET['kota']==""&&$_GET['kecamatan']==""){
                                                    ...
                                                    $where = " and provinsi='$provinsi' order by kabupaten" ;
                                                } else if ($_GET['kota']!=""&&$_GET['kecamatan']==""){
                                                    $kabupaten = $_GET['kota'];
                                                    $where = " and kabupaten = '$kabupaten' order by kecamatan";
                                                } else if ($_GET['kecamatan']!=""){
                                                    $kecamatan = $_GET['kecamatan'];
                                                    $where = " and kecamatan = '$kecamatan' order by desa ";
                                                }
                                               // echo $where;
                                                $q = mysql_query("SELECT a.id, a.kode, a.nama,  CONCAT(a.tempatlahir, ', ', DATE_FORMAT(a.tanggallahir, '%d/%m/%Y')) AS ttl, 
                                                        CONCAT(a.alamat, ' ', a.desa) AS alamat, d.kecamatanNama, c.kabupatenNama, CONCAT(a.hp1,' ', a.hp2) AS hp, 
                                                        DATE_FORMAT(a.tanggaldaftar, '%d/%m/%Y') AS tanggaldaftar FROM anggota_master a, anggota_status b, kabupaten c, kecamatan d WHERE a.status=1 AND a.kecamatan=d.kecamatanId AND a.kabupaten=c.kabupatenId
                                                        AND a.status_anggota=b.id".$where);

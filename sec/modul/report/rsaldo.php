                                ...
                                <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered table-striped" id="hidden-table-info">
                                    ...
                                    <tbody>
                                       ...
                                       if (!empty($_GET['ver'])) {
                                        ...
                                        //echo $where;
                                        $q = mysql_query("SELECT b.kode, b.idlama, b.nama, c.kecamatanNama, c.kabupatenNama, SUM(a.debet) AS debet, SUM(a.kredit) AS kredit, SUM(a.debet)-SUM(a.kredit) AS saldo, b.verifikasi FROM anggota_alamatdetail c, anggota_master b LEFT JOIN anggota_simpanan a ON b.kode=a.kode_anggota WHERE b.status=1 AND b.kode=c.kode" .$where. "".$wheretahun."" . $wherever . " GROUP BY b.kode order by b.kode ASC;");
...
//                                                    . "<i class='icon-edit'></i></a> <a rel='tooltip-top' title='Hapus' href='javascript: delet(" . $hasil['id'] . ")'><i class='icon-remove'></i></a> </td>";
    ...
    <script type="text/javascript">
                                    ...
                                    $('#sublaporansaldo').attr('class', 'active');

...
// PERBAIKAN: Jika role guru, batasi akses hanya ke halaman tertentu
if (isset($_SESSION['role']) && $_SESSION['role'] === 'guru') {
    // Guru hanya bisa mengakses dashboard, jadwal, absensi
    // Redirect jika mencoba akses database.php

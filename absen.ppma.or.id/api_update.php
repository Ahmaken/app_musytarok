...
try {
    ...
    $allowedTables = [
        'murid', 'guru', 'users', 'absensi', 
        'pelanggaran', 'perizinan', 'alumni',
        'absensi_quran', 'absensi_kegiatan', 'absensi_kamar',  // TABEL BARU
        'jadwal_madin', 'jadwal_quran', 'jadwal_kegiatan',
        'absensi_guru', 'login_attempts'
    ];

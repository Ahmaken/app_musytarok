...
// PENGATURAN HAK AKSES WALI
if (isset($_SESSION['role'])) {
    if ($_SESSION['role'] === 'wali_murid' && isset($_SESSION['murid_id'])) {
        $murid_id = $_SESSION['murid_id'];
        $kelas_id = null;
        $kelas_quran_id = null;
        $kegiatan_id = null;
    } elseif ($_SESSION['role'] === 'wali_kelas' && isset($_SESSION['kelas_id'])) {
        if (!$murid_id) { // Jika tidak sedang mencari spesifik murid
            ...
            <div class="card-body">
                <form method="GET" action="">
                    <div class="row">
                        ...
                        <!-- Filter Murid -->
                        <?php if (!isset($_SESSION['role']) || $_SESSION['role'] !== 'wali_murid'): ?>
                        <div class="col-md-12 mb-6">

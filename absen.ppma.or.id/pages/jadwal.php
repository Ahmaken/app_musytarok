...
if ($guru_id) {
    ...
    $sql_jadwal .= " AND j.kelas_madin_id = ?";
}
...
if ($stmt_jadwal) {
    if ($guru_id) {
        ...
        $stmt_jadwal->bind_param("i", $_SESSION['kelas_id']);
    }
    $stmt_jadwal->execute();
                    ...
                    <div class="card-header bg-info text-white d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            ...
                            <a href="https://docs.google.com/spreadsheets/d/1o8Q5i4Wk2x2o_kT9Hfaud6DYhbrSznrqX9EVQySfRr0/edit#gid=1913039132" 
                               target="_blank" 
                               class="btn btn-sm btn-outline-light border-2 me-2">
                                <i class="bi bi-file-earmark-excel me-1"></i> Google Sheet
                            </a>
                            <?php endif; ?>
                        ...
                        <div class="table-responsive">
                            <table id="kegiatanTable" class="table table-hover table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td data-title="Hari"><?= htmlspecialchars($kegiatan['hari']) ?></td>  <!-- PERBAIKAN: ganti $jadwal dengan $kegiatan -->
                                        <td data-title="Nama Kegiatan"><?= htmlspecialchars($kegiatan['nama_kegiatan']) ?></td>  <!-- PERBAIKAN: ganti $jadwal['mata_pelajaran'] dengan $kegiatan['nama_kegiatan'] -->
                                        <td data-title="Kamar"><?= htmlspecialchars($kegiatan['nama_kamar']) ?></td>  <!-- PERBAIKAN: ganti $jadwal['nama_kelas'] dengan $kegiatan['nama_kamar'] -->
                                        <td data-title="Jam Mulai"><?= htmlspecialchars($kegiatan['jam_mulai']) ?></td>  <!-- PERBAIKAN: ganti $jadwal dengan $kegiatan -->
                                        <td data-title="Jam Selesai"><?= htmlspecialchars($kegiatan['jam_selesai']) ?></td>  <!-- PERBAIKAN: ganti $jadwal dengan $kegiatan -->
                                        <td data-title="Pembina"><?= htmlspecialchars($kegiatan['nama_guru'] ?? 'Belum ada pembina') ?></td>  <!-- PERBAIKAN: ganti $jadwal dengan $kegiatan -->
                                        <td>

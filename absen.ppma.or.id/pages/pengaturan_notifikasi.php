...
<body>
    <div class="container mt-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2><i class="bi bi-whatsapp me-2"></i> Pengaturan Notif Whatsapp</h2>
            
        </div>
        
        <div class="d-flex justify-content-between align-items-center">
                <a href="../blast/index.php" class="btn btn-warning">
                    <i class="bi bi-gear me-1"></i> Ke Halaman Pengaturan Whatsapp Otomatis
                </a>
        </div>

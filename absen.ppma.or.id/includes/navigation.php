        ...
        <div class="dropdown d-none d-lg-block">
            ...
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                ...
                <?php if ($_SESSION['role'] == 'admin' || $_SESSION['role'] == 'staff'): ?>
                    <li><a class="dropdown-item" href="pengaturan_notifikasi.php"><i class="bi bi-sliders me-2"></i>Notifikasi & Whatsapp</a></li>
                    <li><hr class="dropdown-divider"></li>
                    ...
                    <li><a class="dropdown-item" href="database.php"><i class="bi bi-people me-2"></i>Personalia</a></li>
                    <li><hr class="dropdown-divider"></li>
                <?php endif; ?>    
                <li><a class="dropdown-item" href="kelas.php"><i class="bi bi-journal-bookmark me-2"></i>Kelas</a></li>
                <li><hr class="dropdown-divider"></li>
                <li><a class="dropdown-item" href="kamar.php"><i class="bi bi-door-closed me-2"></i>Kamar</a></li>
                <li><hr class="dropdown-divider"></li>
                <li><a class="dropdown-item" href="jurnal.php"><i class="bi bi-clipboard-data me-2"></i>Jurnal</a></li>
                <li><hr class="dropdown-divider"></li>
                <li><a class="dropdown-item" href="alumni.php"><i class="bi bi-mortarboard me-2"></i>Alumni</a></li>
                <li><hr class="dropdown-divider"></li>
                <li><a class="dropdown-item" href="?clear_hijri_cache=1"><i class="bi bi-arrow-clockwise me-2"></i>Refresh Hijry</a></li>
                <li><hr class="dropdown-divider"></li>
                <li><a class="dropdown-item" href="settings.php"><i class="bi bi-gear me-2"></i>Pengaturan</a></li>
                <li><hr class="dropdown-divider"></li>
                <li><a class="dropdown-item" href="https://wa.me/628133129223" target="_blank">
    ...
    <div class="sidebar-content">
        ...
        <div class="user-access-admin">
            ...
            <a href="pengaturan_notifikasi.php" class="sidebar-item">
                <i class="bi bi-sliders me-2"></i>Notifikasi & Whatsapp
            </a>
        ...
        <div class="user-info-mobile">    
            ...
            <div class="user-actions">
                ...
                <a href="https://wa.me/628133129223" target="_blank" class="btn btn-sm btn-outline-light mb-2">
                    <i class="bi bi-whatsapp me-2"></i>Layanan Pengaduan
                </a>
